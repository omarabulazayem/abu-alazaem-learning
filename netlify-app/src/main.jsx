...
const childWorldAsset=`${import.meta.env.BASE_URL||"/"}assets/abu-alazayem-child-world.webp`;
document.documentElement.style.setProperty("--child-world-image",`url("${childWorldAsset}")`);
