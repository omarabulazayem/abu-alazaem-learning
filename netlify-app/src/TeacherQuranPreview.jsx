...
import {Button,Empty,Hero,Section,go,getLessonContext,saveLessonContext} from "./ui-v4.jsx";

export default function TeacherQuranPreview(){
  const [query,setQuery]=useState(""); const [lessonContext,setLessonContext]=useState(()=>getLessonContext());
